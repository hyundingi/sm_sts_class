					...
					<div class="orderDivMt">
						<table summary="NO, 제목, 등록일, 조회수 순으로 공지사항을 조회 하실수 있습니다." class="orderTable2" border="1" cellspacing="0">
							...
							<thead>
								...
								<th scope="col" class="tnone">성별</th>
...
<!-- 								</tr> -->
								...
								<!-- 게시글 날짜 -->
								<tr>
									<td class="tnone">${ct.id }</td>
									<td class="left">
										<a href="/member/mview?id=${ct.id }" class="lightgray">${ct.name }</a>
									</td>
									<td class="tnone right">${ct.phone }</td>
									<td class="tnone right">${ct.gender }</td>
									<td>
									<fmt:formatDate value="${ct.mdate}" pattern="yyyy-MM-dd"/>
									</td>
								</tr>
								</c:forEach>
					...
					<div class="searchWrap">
						<div class="search">
						<form action="/customer/notice" method="get" name="searchFrm">
							<ul>
								...
								<li><input type="text" name="searchW" class="searchInput" /></li>
								<li class="web"><button type="button" onclick="searchBtn()"><img src="../images/btn/btn_search.gif" alt="검색" /></button></li>
