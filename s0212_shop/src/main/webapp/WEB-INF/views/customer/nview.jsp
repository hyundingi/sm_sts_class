			...
			<div id="contents">
				<div id="customer">
					...
					<div class="viewDivMt">
						...
						<div >
							<img alt="" src="/upload/board/${bdto.bfile }" width="50%">
						</div>
						</c:if>
					</div>
						...
						<table summary="이전다음글을 선택하여 보실 수 있습니다." class="preNext" border="1" cellspacing="0">
							...
							<tbody>
								...
								<tr>
									...
									<td><a href="/customer/nview?bno=${prev.bno }">${prev.btitle}</a></td>
								</tr>
								</c:if>
								...
								<tr>
									...
									<td><a href="/customer/nview?bno=${next.bno }">${next.btitle}</a></td>
								</tr>
								</c:if>
